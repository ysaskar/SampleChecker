...
namespace SampleChecker.External
{
    public class ConsumerService : BackgroundService
    {
        ...
        private readonly IConsumeProcess _nettingPartTwoStatusChecker;


        public ConsumerService(IConfiguration config, ILogger<ConsumerService> logger, NettingPartTwoStatusChecker nettingPartTwoStatusChecker)
        {
            _logger = logger;
            _config = config;
            ...
            _nettingPartTwoStatusChecker = nettingPartTwoStatusChecker;
        }
